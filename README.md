...
- Xcode 26.x, deployment target iOS 18.0
...
Requirements: Xcode 26.x with an installed simulator runtime satisfying iOS 18.0 or newer.
...
- The minimum supported OS is iOS 18.0; Apple Translation features remain runtime-gated to iOS 26.0 and use the existing fallback on older systems.
- CI may run on any installed simulator runtime newer than the iOS 18.0 deployment target.
